  ...
  return (
    <article className="overflow-hidden rounded-[8px] bg-[var(--color-primary-3)] shadow-[var(--shadow-card)]">
      <div className="relative aspect-[4/3] select-none overflow-hidden has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-inset has-[:focus-visible]:ring-[var(--color-primary-1)]">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(48,37,31,0.12),transparent_28%,transparent_62%,rgba(48,37,31,0.28)_100%)]" />

        <span className="pointer-events-none absolute left-2 top-2 rounded-full bg-[rgba(48,37,31,0.72)] px-2 py-1 text-[8px] font-extrabold uppercase tracking-[0.12em] text-white backdrop-blur-sm">
          Before
        </span>
        ...
        <div
          className="pointer-events-none absolute inset-y-0 z-10 w-0.5 bg-white shadow-[0_0_8px_rgba(48,37,31,0.35)]"
          style={{ left: `${position}%` }}
        >
        ...
        <div className="pointer-events-none absolute bottom-3 left-3 right-3 z-30 flex justify-center">
          <p className="inline-flex min-h-7 items-center rounded-full border border-[rgba(48,37,31,0.22)] bg-white/90 px-3 text-center text-[10px] font-extrabold uppercase tracking-[0.06em] text-[var(--color-foreground)] backdrop-blur">
            {title}
          </p>
        </div>
      </div>
