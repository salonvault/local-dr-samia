...
import heroBackground from "../../public/assets/bg-pink-3.png";
  ...
  return (
    <div className="relative h-[104px] w-[104px] shrink-0 overflow-hidden rounded-[14px] bg-white/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.42)] md:h-[118px] md:w-[118px]">
      <Image
        ...
        alt="Clinical facial treatment at Dr Samia Skin Clinic in Gujranwala"
        fill
        sizes="168px"
        className="object-cover"
        style={{ objectPosition: "62% 54%" }}
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(93,7,42,0.18))]" />
    </div>
  );
}
...
function ArrowBadge() {
  return (
    <span className="hero-cta-icon bg-white text-[var(--color-primary-1)]">
...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-white p-[2px] text-white">
      <div className="relative min-h-[calc(100vh-4px)] overflow-hidden bg-[#9b0b45] shadow-[0_26px_70px_rgba(93,7,42,0.2)]">
        <Image
          src={heroBackground}
          alt=""
          fill
        ...
        <div className="absolute inset-y-0 right-[12%] z-0 hidden w-[60%] min-w-[560px] [mask-image:linear-gradient(to_bottom,#000_0%,#000_72%,transparent_99%)] [-webkit-mask-image:linear-gradient(to_bottom,#000_0%,#000_72%,transparent_99%)] lg:block">
        ...
        <div className="relative z-100 flex min-h-[calc(100vh-4px)] flex-col px-5 pb-6 pt-24 sm:px-7 md:px-12 md:pt-28 lg:grid lg:grid-rows-[auto_1fr_auto] lg:px-16 lg:pb-9 lg:pt-36">
          <div className="max-w-[690px]">
            <p className="hero-kicker">
              ...
              Skin &amp; aesthetic care in Gujranwala
            </p>

            <h1 className="heading-h1 hero-title mt-5">
              Healthy Skin,
              <span className="hero-title-accent  font-black! block">Confident You.</span>
            </h1>

            <div className="mt-5 flex max-w-[410px] items-center gap-4 text-[#ffd2e3]/74">
            ...
            <p className="hero-copy mt-6">
              Personalised skin, hair, laser, and aesthetic treatments at Dr Samia Skin Clinic in Garden Town Phase 3.
            </p>

            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <a href="https://wa.me/923392006332" target="_blank" rel="noopener noreferrer" className="hero-cta bg-[var(--color-primary-1)] text-white shadow-[0_18px_38px_rgba(93,7,42,0.26)] transition hover:bg-[var(--color-primary-2)]">
                Book Appointment
                <ArrowBadge />
              </a>
          ...
          <div className="relative z-10 mt-[-46px] flex items-center gap-3 rounded-[14px] border border-white/16 bg-[#8a1746]/64 p-4 shadow-[0_22px_54px_rgba(61,5,28,0.24)] backdrop-blur-xl md:max-w-[520px] lg:hidden">
            ...
            <div>
              ...
              <p className="offer-note mt-2 max-w-[190px] text-white/62">
                A careful skin assessment before any treatment plan.
              </p>
            </div>
          </div>

          {/* <div className="relative hidden lg:block">
            <div className="absolute -bottom-8 -right-10  flex w-[360px] items-center gap-4 rounded-[14px] border border-white/16 bg-[#9b5919]/58 p-3 shadow-[0_24px_70px_rgba(49,20,4,0.28)] backdrop-blur-xl  xl:w-[410px]">
              <MiniImage />
              <div>
          ...
          <a id="book" href="https://wa.me/923392006332" className="sr-only">
            Book Appointment
          </a>
        </div>
      </div>
