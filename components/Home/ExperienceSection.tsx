...
export default function ExperienceSection() {
  return (
    <section id="services" className="bg-[var(--warm-cream)]  text-[var(--color-foreground)]">
      <div className="relative min-h-[540px] overflow-hidden bg-[#fff5f2] lg:min-h-[520px]">
        ...
        <div className="container relative z-10 flex min-h-[540px] items-center py-10 lg:min-h-[520px] lg:justify-end lg:py-10">
          <div className="w-full rounded-[14px] border border-[rgba(156,49,70,0.12)] bg-white/90 p-5 shadow-[0_26px_80px_rgba(156,49,70,0.14)] backdrop-blur-xl sm:p-6 lg:w-[600px] lg:p-6">
